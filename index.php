      ...
      ?>
        <div class="bannerContent <?php echo $produtos[0] ? "active" : "" ?>">
          <div class="bannerLeftSide">
            <h1 class="text-xl"><?php echo $proActual["nome_produto"] ?></h1>
            ...
            <div class="actions">
              <a style="background-color: #CCA152; border: none; color: #1d1e20" href="./adicionar_carrinho.php?id_produto=<?php echo $proActual["id_produto"] ?>" class="btn btn-primary">Adicionar ao carrinho</a>
